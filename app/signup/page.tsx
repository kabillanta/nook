  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#F7F6F3] p-6 text-[#1F2933]">
      ...
      <div className="w-full max-w-md bg-white border border-[#E1E5EA] shadow-sm p-8 rounded-sm">
        <h1 className="font-serif text-2xl font-bold text-[#1F2933] mb-2">Initialize Identity</h1>
        ...
        <form className="space-y-5">
          ...
          <div className="space-y-2">
            <label className="text-xs font-bold uppercase tracking-wider text-[#4B5563]" htmlFor="username">
              Claim Handle
            </label>
            ...
            <p className="text-[10px] text-[#9AA5B1]">This will be your public identifier forever.</p>
          </div>
          ...
          <div className="flex items-start gap-3 pt-2">
            <div className="mt-1">
               <input type="checkbox" className="accent-[#2F3E46] w-4 h-4 cursor-pointer" id="terms" />
            </div>
            <label htmlFor="terms" className="text-xs text-[#6B7280] leading-relaxed cursor-pointer select-none">
              I understand that commitments made on Nook cannot be edited or deleted once published.
            </label>
          </div>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-white px-2 text-[#9AA5B1]">Or sign up with</span>
          </div>
        </div>
        ...
        <div className="mt-8 text-center border-t border-[#E1E5EA] pt-6">
          <p className="text-sm text-[#6B7280]">
            ...
            <Link href="/login" className="text-[#2F3E46] font-bold hover:underline">
              Sign In.
            </Link>
          </p>
        </div>
